...
# image_path = "/home/nehoray/PycharmProjects/UniversaLabeler/data/tested_image/sky/street_from_sky.jpeg"
image_path = "/home/nehoray/PycharmProjects/UniversaLabeler/data/tested_image/sky/street_from_sky_half_size.png"
...
ul_detection = ULDetection(
    ...
    model_names=[
        ...
        ModelNameRegistryDetection.OPENGEOS.value,
        ModelNameRegistryDetection.WALDO.value,
    ],
...
ul_segmentation = ULSegmentation(
    ...
    model_names=[
        ...
        ModelNameRegistrySegmentation.OPEN_EARTH_MAP.value
    ],
