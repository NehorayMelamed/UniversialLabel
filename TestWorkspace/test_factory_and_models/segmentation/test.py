...
class SegmentationModelTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.test_image_path = TEST_IMAGE_SKY_DETECTION_PATH # Replace with actual test image path
    ...
    def test_open_earth_map_model(self):
        """Test OpenEarthMap segmentation model."""
        ...
        self._run_segmentation(ul_segmentation, "sample_image")
