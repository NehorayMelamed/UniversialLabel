...
if __name__ == "__main__":
    ...
    # Load the model
    model_dir = "/home/nehoray/PycharmProjects/UniversaLabeler/common/weights/openEarhMap"
    model = load_model(model_dir=model_dir, model_name="u_former_best.pth", device="cuda")

    # Segment an image
    image_path = "/home/nehoray/PycharmProjects/UniversaLabeler/data/images/mix/small_car.jpeg"  # replace with your image path
